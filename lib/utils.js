...
export function sendConfirmationEmail(response) {
...
export function getNestedField(object, field) {
  if (!field) {
    return null;
  }
...
export function removeFileFromDisk(nameOnDisk) {
...
export function validateNamespaceForPath(namespace) {
...
export function validateNamespaceForField(namespace) {
  if (namespace !== '' && namespace !== undefined && namespace !== null) {
    return `${namespace}__`;
  } else {
    return '';
