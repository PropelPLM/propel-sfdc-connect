import PropelHelper from './PropelHelper';
import PropelConnect from './PropelConnect';
 ...
 */
export const createPropelContext = async ({hostUrl, sessionId, connection, app = PDLM_APP} = {}) => {
